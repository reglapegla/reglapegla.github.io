...
import sty from "./PlasmicButton.module.css"; // plasmic-import: ws-jSm8NK60EsG/css
    ...
    >
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__shcBq)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___0HArt)}
                role={"img"}
              />
            ),
