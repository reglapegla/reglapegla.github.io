...
import sty from "./PlasmicPriceSection.module.css"; // plasmic-import: 0BmTjQA_R2wn2D/css
    ...
    >
      {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__lsh11)}
        >
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox__fMHo3)}>
              <PriceCard
                borders={["flatLeft"]}
                className={classNames("__wab_instance", sty.priceCard__pXzLy)}
              />
            </div>
          ) : null}
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox__wSa8J)}>
              <div className={classNames(projectcss.all, sty.freeBox__n4IOi)}>
                <div
              ...
              {(
                ...
                <PriceCard
                  borders={["flatCenter"]}
                  className={classNames("__wab_instance", sty.priceCard__qaasT)}
                />
              ) : null}
            </div>
          ) : null}
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox__kNsj)}>
              <PriceCard
                borders={
                ...
                className={classNames("__wab_instance", sty.priceCard__cXzib)}
              />
            </div>
          ) : null}
        </p.Stack>
